...
class ExoSystem:
    ...
    def fit(self, name: str, nburn: int, nrun: int, fit_transit: bool, fit_rv: bool, fit_star: bool, parallel: bool = False, nwalk: int = 0,
            fit_ld = False, use_priors = False, rv_bkg_order: int = 0, star_run: str = None, save_samples = False, sigma_clip: float = 5,
        ...
        if self.parallel:
            ...
            self.run_sampler_pool(pos, skip_state_check)
    ...
    def run_sampler(self, pos: np.typing.NDArray, skip_state_check: bool):
        ...
        print('\nRunning MCMC burn-in.', time.time())
        ...
        print('\nRunning MCMC sampling.', time.time())
    ...
    def run_sampler_pool(self, pos: np.typing.NDArray, skip_state_check: bool):
        ...
        with Pool(processes = 10, initializer=self.setup_miniexs) as pool:
...
def log_like(par_in: dict) -> tuple[float, np.typing.ArrayLike, np.typing.ArrayLike]:
